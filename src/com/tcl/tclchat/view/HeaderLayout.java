...
import com.tcl.tclchat.util.PixelUtil;
...
public class HeaderLayout extends LinearLayout{
	...
	public void setTitleAndRightButton(CharSequence title, int backid,String text,
		...
		if (mRightImageButton != null && backid > 0) {
			mRightImageButton.setWidth(PixelUtil.dpTopx(45));
			mRightImageButton.setHeight(PixelUtil.dpTopx(40));
	...
	public void setTitleAndRightImageButton(CharSequence title, int backid,
		...
		mLayoutRightContainer.setVisibility(View.VISIBLE);
		if (mRightImageButton != null && backid > 0) {
			mRightImageButton.setWidth(PixelUtil.dpTopx(30));
			mRightImageButton.setHeight(PixelUtil.dpTopx(30));
